...
$user = mysqli_fetch_assoc(mysqli_query($conn, "SELECT * FROM admin WHERE id = $sessionId"));
  ...
  <body>
    ...
    Announcement</marquee>
        ...
        <div class="box-container">
            ...
            <div class="box">
                <a href="ad1_dashboard.php"><img src="mca.jpeg" alt=""></a>
                <h3>MCA</h3>
              
            </div>

            <div class="box">
                <a href="#"><img src="mca.jpeg" alt=""></a>
                <h3>MBA</h3>
